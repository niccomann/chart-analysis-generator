...
class AgentManager:
    ...
    def create_agents(self):
        ...
        if self.query:
            self.research_agent_sql = create_agent(self.llm, [tools_sql], system_message=prompt_sql_with_advice)
        else:

            self.research_agent_sql = create_agent(self.llm, [tools_sql], system_message=prompt_sql)
